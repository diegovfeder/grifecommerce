describe("# Keystone", () => {
	...
	// it should have a database running
	// it should have a database schema
	// it should have a database model
	// it should have a database model with a schema
	// it should have a database model with a schema with a field
